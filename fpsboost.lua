...
if _G.SendNotifications then
    Window:Notify({
        Title = "FPS Booster Update",
        Description = "Loading FPS Booster...",
        Lifetime = math.huge
    })
end
coroutine.wrap(pcall)(function()
    if (_G.Settings["Low Water Graphics"] or (_G.Settings.Other and _G.Settings.Other["Low Water Graphics"])) then
        ...
        if sethiddenproperty then
            ...
            Window:Notify({
                Title = "FPS Booster Update",
                Description = "Your exploit does not support sethiddenproperty, please use a different exploit.",
                Lifetime = 5
            })
        ...
        if _G.SendNotifications then
            Window:Notify({
                Title = "FPS Booster Update",
                Description = "Low Water Graphics Enabled",
                Lifetime = 5
            })
        end
...
coroutine.wrap(pcall)(function()
    if _G.Settings["No Shadows"] or (_G.Settings.Other and _G.Settings.Other["No Shadows"]) then
        ...
        if _G.SendNotifications then
            Window:Notify({
                Title = "FPS Booster Update",
                Description = "No Shadows Enabled",
                Lifetime = 5
            })
        end
        if _G.ConsoleLogs then
...
coroutine.wrap(pcall)(function()
    if _G.Settings["Low Rendering"] or (_G.Settings.Other and _G.Settings.Other["Low Rendering"]) then
        ...
        if _G.SendNotifications then
            Window:Notify({
                Title = "FPS Booster Update",
                Description = "Low Rendering Enabled",
                Lifetime = 5
            })
        end
        if _G.ConsoleLogs then
...
coroutine.wrap(pcall)(function()
    if _G.Settings["Reset Materials"] or (_G.Settings.Other and _G.Settings.Other["Reset Materials"]) then
        ...
        if _G.SendNotifications then
            Window:Notify({
                Title = "FPS Booster Update",
                Description = "Reset Materials Enabled",
                Lifetime = 5
            })
        end
        if _G.ConsoleLogs then
...
coroutine.wrap(pcall)(function()
    if _G.Settings["FPS Cap"] or (_G.Settings.Other and _G.Settings.Other["FPS Cap"]) then
        if setfpscap then
            local fpsCap = tonumber(_G.Settings["FPS Cap"] or (_G.Settings.Other and _G.Settings.Other["FPS Cap"]))
            setfpscap(fpsCap)
            if _G.SendNotifications then
                Window:Notify({
                    Title = "FPS Booster Update",
                    Description = "FPS Capped to " .. tostring(fpsCap),
                    Lifetime = 5
                })
            end
            if _G.ConsoleLogs then
...
if _G.SendNotifications then
    Window:Notify({
        Title = "FPS Booster Update",
        Description = "Checking " .. #Descendants .. " Instances...",
        Lifetime = 15
    })
end
if _G.ConsoleLogs then
...
Window:Notify({
    Title = "FPS Booster Update",
    Description = "FPS Booster Loaded!",
    Lifetime = math.huge
})
